...
# Φτιάχνουμε ένα λεξικό: κάθε βαθμίδα εκπαίδευσης -> έναν αριθμό
edu_map = {}
...
X_train, X_test, y_train, y_test, idx_train, idx_test = train_test_split(
    df_proc.values, y.values, all_idx,
    test_size=0.20, random_state=42, stratify=y.values
)
...
# Κρατάμε τους δείκτες των features που ΔΕΝ είναι μακροοικονομικά
cluster_feature_idx = []
